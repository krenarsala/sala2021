...
var userFeed = new Instafeed({
    get: 'user',
    userId: '256163539',
    accessToken: '256163539.1677ed0.cc7d135586864325901b7d69adf932ae',
    limit: '6',
    resolution: 'standard_resolution',
    template: '<a class="ig_image" href="{{link}}" style="background: url({{image}}); background-size: cover; background-position: center center;"></a>'
});
userFeed.run();
